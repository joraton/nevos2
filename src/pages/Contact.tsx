                  ...
                  >
                    ...
                    <motion.div whileFocus={{ scale: 1.02 }}>
                      <Input
                        ...
                        className="h-14 text-base border-2 border-border/50 focus:border-primary/50 rounded-xl bg-background/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 placeholder:text-gray-400"
                      />
                    </motion.div>
                  </motion.div>
                  ...
                  >
                    ...
                    <motion.div whileFocus={{ scale: 1.02 }}>
                      <Textarea
                        ...
                        className="text-base border-2 border-border/50 focus:border-primary/50 rounded-xl bg-background/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 resize-none placeholder:text-gray-400"
                      />
                    </motion.div>
                  </motion.div>
