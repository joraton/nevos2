    ...
    return (
      ...
      >
        ...
        <div className={cn("-z-30 blur-[2px]", "[container-type:size] absolute inset-0 overflow-visible")}>
          {/* spark */}
          <div className="animate-shimmer-slide absolute inset-0 [aspect-ratio:1] h-[100cqh] h-full [border-radius:0] [mask:none]">
            {/* spark before */}
