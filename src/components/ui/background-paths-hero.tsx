/**
 * @description: Background Paths Hero - 36 floating SVG paths with text animation
 * @version: 1.0.0
 * @license: MIT
 */
...
export const BackgroundPathsHero = ({
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-accent/5">
      {/* SVG Background with 36 floating paths */}
          ...
          <defs>
            {paths.map((_, index) => (
              ...
              >
                ...
                <stop offset="50%" stopColor="oklch(0.6692 0.1607 245.0110)" stopOpacity="0.5" />
      ...
      {/* Glassmorphism overlay at bottom for smooth transition */}
